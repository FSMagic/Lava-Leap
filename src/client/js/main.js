...
app.main = {
	...
	init : function() {
		...
		for(var i = 0; i < playerColors.length; i++){
			...
			var image = new Image();
			image.src = "/assets/img/" + playerColors[i] + "_character_idle.png";
			images.push(image);
			
			image = new Image();
			image.src = "/assets/img/" + playerColors[i] + "_running_v2.png";
			images.push(image);
			
			image = new Image();
			image.src = "/assets/img/" + playerColors[i] + "_character_jumping.png";
			images.push(image);
			
			image = new Image();
			image.src = "/assets/img/" + playerColors[i] + "_character_falling.png";
			images.push(image);
		...
		this.TitleScreen.src = "/assets/img/TITLESCREEN.jpg";
		
		this.platformImage = new Image();
		this.platformImage.src = "/assets/img/lavatile.png";
		
		this.islandImage = new Image();
		this.islandImage.src = "/assets/img/parrallax_background_background.png";
		...
		this.backImages[0].src = "/assets/img/largewalltile-scaled.png";
		this.backImages[1].src = "/assets/img/largewalltile-scaled-v2.png";
		this.backImages[2].src = "/assets/img/largewalltile-scaled-v3.png";
		this.backImages[3].src = "/assets/img/parrallax_background_foreground.png";
		this.backImages[4].src = "/assets/img/background_face_fullsize.png";
		this.backImages[5].src = "/assets/img/background_whale_fullsize.png";
		...
		this.gradients[0].src = "/assets/img/gradient_v1.png";
		this.gradients[1].src = "/assets/img/gradient_v2.png";
		this.gradients[2].src = "/assets/img/gradient_v3.png";
		this.gradients[3].src = "/assets/img/gradient_v4.png";
		
		this.parallaxWallBack = new Image();
		this.parallaxWallBack.src = "/assets/img/parallax wall back shaded.png";
		this.parallaxWallFront = new Image();
		this.parallaxWallFront.src = "/assets/img/parallax wall front shaded.png";
		
		this.lavaImage = new Image();
		this.lavaImage.src = "/assets/img/animated lava.png";
		
		this.loadImgs();
		
		//tramp tile
		var platformImage = new Image();
		platformImage.src = "/assets/img/jumpirontile_animated_v2.png";
		this.platformImages.push(platformImage);
		
		//sticky tile
		platformImage = new Image();
		platformImage.src = "/assets/img/stickytile_vanishing_animated.png";
		this.platformImages.push(platformImage);
		
		//ghost tile
		platformImage = new Image();
		platformImage.src = "/assets/img/ghosttile.png";
		this.platformImages.push(platformImage);
		
		platformImage = new Image();
		platformImage.src = "/assets/img/ghosttile vanishing full animation.png";
		this.platformImages.push(platformImage);
		
		//moving tiles
		platformImage = new Image();
		platformImage.src = "/assets/img/wallfurrow.png";
		this.platformImages.push(platformImage);
	...
	update: function()
	{
		...
		if(makeSound){
			var sfx = new Audio("/assets/music/sfx.mp3");
			sfx.volume = 0.4;
			sfx.play();
		}
	...
	//instructions
		...
		this.insBackground.src = "/assets/img/instructions/INS.jpg";
		
		this.insIntro= new Image();
		this.insIntro.src = "/assets/img/instructions/intro.png";
		
		this.insSingle = new Image();
		this.insSingle.src = "/assets/img/instructions/singleplayer.png";
		
		this.insMulti= new Image();
		this.insMulti.src = "/assets/img/instructions/multiplayer.png";
		
		this.insXcontrols = new Image();
		this.insXcontrols.src = "/assets/img/instructions/controls.png";
		
		this.insKcontrols = new Image();
		this.insKcontrols.src = "/assets/img/instructions/keycontrols.png";
		
	   this. insPlat = new Image();
		this.insPlat.src = "/assets/img/instructions/normPlat.png";
		
	   this. insStick = new Image();
		this.insStick.src = "/assets/img/instructions/stickyPlat.png";
		
		this.insTramp= new Image();
		this.insTramp.src = "/assets/img/instructions/trampPlat.png";
		
		this.insGhost = new Image();
		this.insGhost.src = "/assets/img/instructions/ghostPlat.png";
	
	//large Idle for select screen\
	
		this.blueIdle = new Image();
		this.blueIdle.src = "/assets/img/multiplayer/blueIdleXL.png";
		
		this.greenIdle = new Image();
		this.greenIdle.src = "/assets/img/multiplayer/greenIdleXL.png";
		
		this.purpleIdle = new Image();
		this.purpleIdle.src = "/assets/img/multiplayer/purpleIdleXL.png";
		
		this.tealIdle = new Image();
		this.tealIdle.src = "/assets/img/multiplayer/tealIdleXL.png";
		
		this.greyIdle = new Image();
		this.greyIdle.src = "/assets/img/multiplayer/greyIdleXL.png";
	},
   drawP1Keys: function (){
		var width = this.WIDTH;
		var height = this.HEIGHT;
...
window.onload = function() {
	...
	var audio = new Audio("/assets/music/thefloorislava.mp3");
	audio.loop = true;
	audio.play();
